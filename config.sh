...
OLLAMA_API="http://192.168.68.121:11434/api/chat"
OLLAMA_MODEL="gemma3:12b-it-qat" #"gemma3:4b-it-qat" #"qwen3:4b" #"hf.co/Qwen/Qwen3-8B-GGUF:Q8_0"
OLLAMA_CTX="4096"
OLLAMA_EMB_API="http://192.168.68.121:11434/api/embeddings"
