...
func Form(user core.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<form class=\"needs-validation\" action=\"/process-uploadCV\" method=\"post\" enctype=\"multipart/form-data\" novalidate><!-- CSRF Protection --><input type=\"hidden\" name=\"csrf_token\" value=\"")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/uploadCV/sections/form/form.templ`, Line: 10, Col: 62}
		}
